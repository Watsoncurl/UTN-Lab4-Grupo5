      ...
      <div class="col-lg-8">
        <div class="card shadow">
          ...
          <div class="card-body">
            ...
            <form id="formCuenta" class="row g-3 needs-validation" method="post" action="ServletAdminAgregarCuenta" novalidate>
              ...
              <div class="col-12 mt-4 pt-3 border-top">
                <div class="d-flex justify-content-between">
                  <a href="ListarCuentasServlet" class="btn btn-outline-danger px-4">
                    <i class="bi bi-arrow-left me-2"></i>Cancelar
                  </a>
                  <button type="submit" name="btnCrearCuenta" class="btn btn-primary px-4">
