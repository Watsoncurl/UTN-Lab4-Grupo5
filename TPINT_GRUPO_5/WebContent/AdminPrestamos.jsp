      ...
      <table class="table table-hover border shadow-sm">
        <thead class="table-light">
		  <tr>
		    ...
		    <th class="text-center">Estado</th> <!-- ✅ centrado -->
		...
		<tbody>
		  <c:forEach var="p" items="${listaPrestamos}">
		    <tr>
		      ...
		      <td class="text-center align-middle"> <!-- ✅ centrado -->
		        <c:choose>
      ...
      <nav class="mt-3">
        <ul class="pagination justify-content-center">
          <li class="page-item ${paginaActual == 1 ? 'disabled' : ''}">
            <a class="page-link" href="ServletAdminPrestamos?pagina=${paginaActual - 1}">Anterior</a>
          </li>

          <c:forEach begin="1" end="${totalPaginas}" var="i">
            <li class="page-item ${paginaActual == i ? 'active' : ''}">
              <a class="page-link" href="ServletAdminPrestamos?pagina=${i}">${i}</a>
            </li>
          </c:forEach>

          <li class="page-item ${paginaActual == totalPaginas ? 'disabled' : ''}">
            <a class="page-link" href="ServletAdminPrestamos?pagina=${paginaActual + 1}">Siguiente</a>
          </li>
        </ul>
      </nav>
    </c:if>
