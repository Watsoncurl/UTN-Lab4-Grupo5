            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0"><i class="bi bi-send me-2"></i>Realizar Transferencia</h4>
                    </div>
                    <div class="card-body">
                        <!-- Mensaje de Error -->
                        ...
                        <form action="TransferirServlet" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="cbuFeedback" class="form-text"></div> <!-- Elemento para mostrar el feedback -->
                            </div>
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary"><i class="bi bi-send me-2"></i>Transferir</button>
                            </div>
                        </form>
                        <div class="mt-3 text-center">
                            <a href="ClienteDashboard.jsp" class="btn btn-secondary"><i class="bi bi-arrow-left me-2"></i>Volver al Dashboard</a>
                        </div>
                    </div>
                </div>
            </div>
